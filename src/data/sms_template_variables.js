...
const smsTemplateVariables = 
  {
    ...
    order_reminder_virtual_dining_diner:[...tagvariables.common,...tagvariables.order,...tagvariables.diner] ,
    ...
    order_completed_virtual_dining_diner:[...tagvariables.common,...tagvariables.order,...tagvariables.diner] ,
