export const common = [
    { title: 'Website Logo', val: '{website.logo}' },
    { title: 'Website Email', val: '{website.email}' },
    { title: 'Website Phone', val: '{website.phone}' },
    { title: 'Website Address', val: '{website.address}' },
    { title: 'Facebook Link', val: '{website.facebook_link}' },
    { title: 'Twitter Link', val: '{website.twitter_link}' },
