            ...
            {items.map((booking, index) => {
              return (
                <div key={index} className="d-flex flex-row mb-3">
                  <NavLink
                    to={`${adminRoot}/booking/view/?b=${booking.id}`}
                  ...
                  >
                    ...
                    <Badge
                      ...
                      color={ booking.status === "Order Placed" ? "info" : booking.status === "Order Paid" ? "success" : booking.status === "Order Completed" ? "primary" : "secondary"}
                      pill
                    >
                      {booking.status}
                    </Badge>
                    ...
                    <NavLink to={`${adminRoot}/booking/view/?b=${booking.id}`}>
                      ...
                      <div className="pr-4">
                        <p className="text-muted mb-1 text-small">
                          ...
                          Host : {booking.user.name}&nbsp;&nbsp;({booking.user.mobile})&nbsp;&nbsp; 
                        </p>
                      </div>
                      <div className="text-primary text-small font-weight-medium d-none d-sm-block">
                        {moment(booking.booking_date).format('MMM , D Y')}
                      </div>
                    </NavLink>
                  </div>
                </div>
