                ...
                <Row>
                  <Colxx xxs="12" md="6">
                    <div>
                      ...
                      <br></br>
                      <Col md={11}>
                        {isImageOrVideo(bookingTypes?.privee?.image) === "video" ? (
                          <video style={{ height: "300px", objectFit: "cover", width: "100%" }} className="video" autoPlay muted loop>
                            <source src={bookingTypes?.privee?.image} type="video/mp4" />
                          </video>
                        ) : (
                          <SingleLightbox
                  ...
                  <Colxx xxs="12" md="6">
                    <div>
                      ...
                      <br></br>
                      <Col md={11}>
                        {isImageOrVideo(bookingTypes?.supper_club?.image) === "video" ? (
                          <video style={{ height: "300px", objectFit: "cover", width: "100%" }} className="video" autoPlay muted loop>
                            <source src={bookingTypes?.supper_club?.image} type="video/mp4" />
                          </video>
                        ) : (
                          <SingleLightbox
