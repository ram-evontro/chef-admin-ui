          ...
          <>
            ...
            <a
              ...
              onClick={() => {
                ...
                updateAction(row.values["details.is_featured"] ? "notfeatured" : "featured", row.values.id);
              }}
              className={`ml-3 glyph-icon ${row.values["details.is_featured"] ? "btn-primary" : ""} simple-icon-star`}
            ></a>
            <a
              title="Delete"
              href="javascript:;"
