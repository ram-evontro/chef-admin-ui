...
const ResetPassword = ({ location, history, loading, error, resetPasswordAction }) => {
      ...
      <Colxx xxs="12" md="10" className="mx-auto my-auto">
        <Card className="auth-card">
          ...
          <div className="form-side">
            ...
            <Formik validate={validateNewPassword} initialValues={initialValues} onSubmit={onResetPassword}>
              {({ errors, touched }) => (
                <Form className="av-tooltip tooltip-label-bottom">
                  ...
                  <FormGroup className="form-group has-float-label">
                    ...
                    <Field className="form-control" name="newPasswordAgain" type="password" />
                    {errors.newPasswordAgain && touched.newPasswordAgain && <div className="invalid-feedback d-block">{errors.newPasswordAgain}</div>}
                  </FormGroup>
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <Button color="primary" className={`btn-shadow btn-multiple-state ${loading ? "show-spinner" : ""}`} size="lg">
