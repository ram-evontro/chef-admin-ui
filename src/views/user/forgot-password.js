...
const ForgotPassword = ({ history, forgotUserMail, loading, error, forgotPasswordAction }) => {
  ...
  useEffect(() => {
    if (error) {
      ...
      NotificationManager.success("Please check your email.", "Forgot Password Success", 3000, null, null, "");
